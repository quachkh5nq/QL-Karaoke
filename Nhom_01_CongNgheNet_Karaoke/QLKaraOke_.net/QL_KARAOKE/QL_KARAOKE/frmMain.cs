...
namespace QL_KARAOKE
{
    public partial class frmMain : Form
    {
        ...
        private void doiTaiKhoanToolStripMenuItem_Click(object sender, EventArgs e)
        {
            var f = new frmDangNhap();
            f.ShowDialog();
            nv = f.nv;
        ...
        {
            MessageBox.Show("vui lòng liên hệ qua hotline:0823494680  để được hỗ trợ kịp thời");
        }
    }
}
